# Generated by Django 3.2 on 2023-02-01 18:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=256, verbose_name='Название')),
                ('description', models.TextField(blank=True, validators=[reviews.validators.validate_lenght], verbose_name='Описание')),
                ('year', models.PositiveSmallIntegerField(blank=True, null=True, validators=[reviews.validators.validate_date], verbose_name='Год выпуска')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.TextField(help_text='Содержимое отзыва', verbose_name='Текст отзыва')),
